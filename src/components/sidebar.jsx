          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            ...
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#timeline" data-nav-section="timeline">Work Timeline</a></li>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <p><a className="btn btn-outline-primary" href="https://blog.willmnorris.com" target="_blank" rel="noopener noreferrer">Blog<i className="icon-book" /></a></p>
